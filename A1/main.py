...
def problem4():
    ...
    threshold = 0.13 # we did experiments trying to identify the most suitable threshold to identify complicated details such as windows and trees, retaing only the most important image edges
